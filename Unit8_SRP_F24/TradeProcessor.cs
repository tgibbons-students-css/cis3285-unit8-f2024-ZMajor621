...
namespace SingleResponsibilityPrinciple
{
    public class TradeProcessor
    {
        ...
        private void StoreTrades(IEnumerable<TradeRecord> trades)
        {
            ...
            string azureConnectString2 = @"Server=tcp:cis3285-sql-server.database.windows.net,1433; Initial Catalog = Unit8_TradesDatabase; Persist Security Info=False; User ID=cis3285;Password=Saints4SQL; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 60;";
            // Change the connection string used to match the one you want
            using (var connection = new SqlConnection(azureConnectString2))
            {
